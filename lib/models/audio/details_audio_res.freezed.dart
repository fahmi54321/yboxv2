...
DetailsAudioRes _$DetailsAudioResFromJson(Map<String, dynamic> json) {
  return _DetailsAudioRes.fromJson(json);
}

/// @nodoc
mixin _$DetailsAudioRes {
  ...
  @JsonKey(ignore: true)
  $DetailsAudioResCopyWith<DetailsAudioRes> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DetailsAudioResCopyWith<$Res> {
  factory $DetailsAudioResCopyWith(
          DetailsAudioRes value, $Res Function(DetailsAudioRes) then) =
      _$DetailsAudioResCopyWithImpl<$Res, DetailsAudioRes>;
  @useResult
  $Res call(
...
/// @nodoc
class _$DetailsAudioResCopyWithImpl<$Res, $Val extends DetailsAudioRes>
    implements $DetailsAudioResCopyWith<$Res> {
  _$DetailsAudioResCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_DetailsAudioResCopyWith<$Res>
    implements $DetailsAudioResCopyWith<$Res> {
  factory _$$_DetailsAudioResCopyWith(
          _$_DetailsAudioRes value, $Res Function(_$_DetailsAudioRes) then) =
      __$$_DetailsAudioResCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'id', defaultValue: '') String id,
...
/// @nodoc
class __$$_DetailsAudioResCopyWithImpl<$Res>
    extends _$DetailsAudioResCopyWithImpl<$Res, _$_DetailsAudioRes>
    implements _$$_DetailsAudioResCopyWith<$Res> {
  __$$_DetailsAudioResCopyWithImpl(
      _$_DetailsAudioRes _value, $Res Function(_$_DetailsAudioRes) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_DetailsAudioRes(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$_DetailsAudioRes extends _DetailsAudioRes {
  const _$_DetailsAudioRes(
  ...
  factory _$_DetailsAudioRes.fromJson(Map<String, dynamic> json) =>
      _$$_DetailsAudioResFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_DetailsAudioResCopyWith<_$_DetailsAudioRes> get copyWith =>
      __$$_DetailsAudioResCopyWithImpl<_$_DetailsAudioRes>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_DetailsAudioResToJson(
      this,
    );
  }
}

abstract class _DetailsAudioRes extends DetailsAudioRes {
  const factory _DetailsAudioRes(
      ...
      @JsonKey(name: 'is_check', defaultValue: 0)
      required final int isCheck}) = _$_DetailsAudioRes;
  const _DetailsAudioRes._() : super._();

  factory _DetailsAudioRes.fromJson(Map<String, dynamic> json) =
      _$_DetailsAudioRes.fromJson;
