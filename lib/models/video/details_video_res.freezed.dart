...
part of 'details_video_res.dart';
...
DetailsVideoRes _$DetailsVideoResFromJson(Map<String, dynamic> json) {
  return _DetailsVideoRes.fromJson(json);
}

/// @nodoc
mixin _$DetailsVideoRes {
  ...
  @JsonKey(ignore: true)
  $DetailsVideoResCopyWith<DetailsVideoRes> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DetailsVideoResCopyWith<$Res> {
  factory $DetailsVideoResCopyWith(
          DetailsVideoRes value, $Res Function(DetailsVideoRes) then) =
      _$DetailsVideoResCopyWithImpl<$Res, DetailsVideoRes>;
  @useResult
  $Res call(
...
/// @nodoc
class _$DetailsVideoResCopyWithImpl<$Res, $Val extends DetailsVideoRes>
    implements $DetailsVideoResCopyWith<$Res> {
  _$DetailsVideoResCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_DetailsVideoResCopyWith<$Res>
    implements $DetailsVideoResCopyWith<$Res> {
  factory _$$_DetailsVideoResCopyWith(
          _$_DetailsVideoRes value, $Res Function(_$_DetailsVideoRes) then) =
      __$$_DetailsVideoResCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'id', defaultValue: '') String id,
...
/// @nodoc
class __$$_DetailsVideoResCopyWithImpl<$Res>
    extends _$DetailsVideoResCopyWithImpl<$Res, _$_DetailsVideoRes>
    implements _$$_DetailsVideoResCopyWith<$Res> {
  __$$_DetailsVideoResCopyWithImpl(
      _$_DetailsVideoRes _value, $Res Function(_$_DetailsVideoRes) _then)
      : super(_value, _then);
...
class _$_DetailsVideoRes extends _DetailsVideoRes {
  const _$_DetailsVideoRes(
  ...
  factory _$_DetailsVideoRes.fromJson(Map<String, dynamic> json) =>
      _$$_DetailsVideoResFromJson(json);
  ...
  _$$_DetailsVideoResCopyWith<_$_DetailsVideoRes> get copyWith =>
      __$$_DetailsVideoResCopyWithImpl<_$_DetailsVideoRes>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_DetailsVideoResToJson(
      this,
    );
  }
}

abstract class _DetailsVideoRes extends DetailsVideoRes {
  const factory _DetailsVideoRes(
