...
_$_DetailsVideoRes _$$_DetailsVideoResFromJson(Map json) => $checkedCreate(
      r'_$_DetailsVideoRes',
      json,
      ($checkedConvert) {
        final val = _$_DetailsVideoRes(
...
Map<String, dynamic> _$$_DetailsVideoResToJson(_$_DetailsVideoRes instance) {
