...
class PublishingForm2 extends StatefulWidget {
  RolesRes? pubRoles;
  ...
  @override
  State<PublishingForm2> createState() => _PublishingForm2State();
}

class _PublishingForm2State extends State<PublishingForm2> {
  @override
  void initState() {
    super.initState();
      ...
      children: [
        ...
        VDropDownPublishing(
          ...
          onChanged: (PublishingRes? data) {
            ...
            if (data != null) {
              context.read<DataTrack>().updatePublishing(data.id.toString());
            }
          },
      ...
      children: [
        ...
        VDropDownRole(
          ...
          onChanged: (RolesRes? data) {
            ...
            if (data != null) {
              context.read<DataTrack>().updateRoleTrack(data.id.toString());
            }
          },
          items:
  ...
  void tracksInputShareListener() {
    if (widget.state.tracksInputShare.text.isNotEmpty) {
      context.read<DataTrack>().updateShare(widget.state.tracksInputShare.text);
    }
  }
}
