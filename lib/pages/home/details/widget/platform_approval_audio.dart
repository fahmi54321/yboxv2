...
import 'package:yboxv2/pages/home/details/widget/platform_approval_audio_state.dart';
...
class PlatformApprovalAudio extends StatefulWidget {
  final String idDetails;
  final int statusFromDetails;
  const PlatformApprovalAudio({
    Key? key,
  ...
  @override
  State<PlatformApprovalAudio> createState() => _PlatformApprovalAudioState();
}

class _PlatformApprovalAudioState extends State<PlatformApprovalAudio> {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => PlatformApprovalAudioState(
        idDetails: widget.idDetails,
        statusFromDetails: widget.statusFromDetails,
        context: context,
      ),
      child: Consumer(
        builder: (BuildContext context, PlatformApprovalAudioState state, _) {
  ...
  Widget buildPlatform({
    ...
    required PlatformApprovalAudioState state,
  }) {
    return Container(
