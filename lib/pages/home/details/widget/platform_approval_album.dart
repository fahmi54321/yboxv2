...
import 'package:yboxv2/pages/home/details/widget/platform_approval_state.dart';
...
class PlatformApprovalAlbum extends StatefulWidget {
  final String idDetails;
  final int statusFromDetails;
  const PlatformApprovalAlbum({
    Key? key,
  ...
  @override
  State<PlatformApprovalAlbum> createState() => _PlatformApprovalAlbumState();
}

class _PlatformApprovalAlbumState extends State<PlatformApprovalAlbum> {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => PlatformApprovalAlbumState(
        idDetails: widget.idDetails,
        statusFromDetails: widget.statusFromDetails,
        context: context,
      ),
      child: Consumer(
        builder: (BuildContext context, PlatformApprovalAlbumState state, _) {
  ...
  Widget buildPlatform({
    ...
    required PlatformApprovalAlbumState state,
  }) {
    return Container(
