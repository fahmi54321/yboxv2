...
import 'package:yboxv2/pages/home/details/widget/platform_approval_video_state.dart';
...
class PlatformApprovalVideo extends StatefulWidget {
  final String idDetails;
  final int statusFromDetails;
  const PlatformApprovalVideo({
    Key? key,
  ...
  @override
  State<PlatformApprovalVideo> createState() => _PlatformApprovalVideoState();
}

class _PlatformApprovalVideoState extends State<PlatformApprovalVideo> {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => PlatformApprovalVideoState(
        idDetails: widget.idDetails,
        statusFromDetails: widget.statusFromDetails,
        context: context,
      ),
      child: Consumer(
        builder: (BuildContext context, PlatformApprovalVideoState state, _) {
  ...
  Widget buildPlatform({
    ...
    required PlatformApprovalVideoState state,
  }) {
    return Container(
